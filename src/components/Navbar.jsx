...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-6 py-6">
      <div className="max-w-7xl mx-auto flex justify-between items-center glass px-6 py-3 rounded-3xl border border-slate-200 light:border-slate-800 bg-blue-100/50/80 light:bg-slate-950/80 backdrop-blur-md">
        <Link
          to="/"
